...
export default function Home() {
        ...
        return (
            <>
                ...
                <img src={main} alt="" style={{ width: "100%", height: "28rem",opacity:"0.8" }} />
                    <div className="container">
                        <h1 className='text-center  fw-bold py-3 pt-5 pb-5 ' style={{ fontSize: "45px",marginTop:"-15rem",zIndex:"99" }}>
                            VXEQ INFRA FACILITIES PVT LTD</h1>
                       
                        <div className="row p-3 pt-5">
                            <div className="col-md-6 col-sm-12 px-5 pt-5 text-center">
                                <p className='fs-5 pt-5 ' style={{ marginTop: "70px" }}>VXEQ.IFPL offer to nail down existing facilities management
                            ...
                            <div className="col-md-6 col-sm-12 pt-5">
                                <h4 className='text-center fs-3 mb-3 mt-1 pt-5'>Salient Features</h4>
